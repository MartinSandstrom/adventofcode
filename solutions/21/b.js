...
var r = ['None 0 0 0', 'Damage1 25 1 0', 'Damage2 50 2 0', 'Damage3 100 3 0', 'Defense 20 0 1', 'Defense 40 0 2', 'Defense 80 0 3'];
...
function fight() {
	...
	while (boss.hP > 0 && player.hP > 0) {
		...
		if (boss.hP <= 0) {
			...
			maxCost = Math.max(currentItemCost, maxCost);
		}
	}
}
